...
class ButtonsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnNormal.setOnClickListener {
            Toast.makeText(requireContext(), "Has presionado un Botón Normal", Toast.LENGTH_SHORT).show()
        }

        imgBtn.setOnClickListener {
            Toast.makeText(requireContext(), "Has presionado un ImageButton (Ícono)", Toast.LENGTH_SHORT).show()
        }
